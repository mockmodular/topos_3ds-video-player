...
typedef enum
{
	...
	/* 播放器：左右键/摇杆 — 按下与连发只改预览（seek_pos_cache），松手才 COMMIT+submit */
	VID_CMD_SEEK_KBD_LR_PREVIEW_FWD,
	VID_CMD_SEEK_KBD_LR_PREVIEW_BACK,
	VID_CMD_SEEK_KBD_LR_RELEASE,
	/* 左右同时按住：清预览、不 seek、不发 PREVIEW/RELEASE */
	VID_CMD_SEEK_KBD_LR_CANCEL_PREVIEW,
