...
#define DEF_UTIL_S_TO_MS_D(s)				(double)(((double)(s)) * 1000.0)
#define DEF_UTIL_S_TO_US_D(s)				(double)(((double)(s)) * 1000000.0)
#define DEF_UTIL_S_TO_NS_D(s)				(double)(((double)(s)) * 1000000000.0)
#define DEF_UTIL_MS_TO_S_D(s)				(double)(((double)(s)) / 1000.0)
#define DEF_UTIL_MS_TO_US_D(s)				(double)(((double)(s)) * 1000.0)
#define DEF_UTIL_MS_TO_NS_D(s)				(double)(((double)(s)) * 1000000.0)
#define DEF_UTIL_US_TO_S_D(s)				(double)(((double)(s)) / 1000000.0)
#define DEF_UTIL_US_TO_MS_D(s)				(double)(((double)(s)) / 1000.0)
#define DEF_UTIL_US_TO_NS_D(s)				(double)(((double)(s)) * 1000.0)
